...
char notes[] = "ggagcb ggagdc gggecba abcbdc ggagcb ggagdc gggecba abcbdc g "; /*notes in the song. Use a space for rests*/
int beats[] = { 2, 2, 2, 3, 3, 4, 2, 2, 2, 2, 2, 4, 1, 1, 3, 2, 2, 2, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 }; /*length of each note. 1 = quarter note*/
int tempo = 200;
